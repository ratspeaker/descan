...
inline DigestAlgorithm::Type EmbeddedTimestampVerificationResult::GetCMSSignatureDigestAlgorithm() const
{
...
inline DigestAlgorithm::Type EmbeddedTimestampVerificationResult::GetMessageImprintDigestAlgorithm() const
{
	DigestAlgorithm::Type result;
...
inline std::vector<X509Certificate> TrustVerificationResult::GetCertPath() const
{
	// Broadly similar to PDFDraw::GetSeparationBitmaps implementation
	TRN_Vector vec = NULL;
...
inline DigestAlgorithm::Type VerificationResult::GetDigestAlgorithm() const
{
	DigestAlgorithm::Type result;
